...
% fig1=figure(1); %'Position',[0.02*scrsz(3) 0.05*scrsz(4) 0.98*scrsz(3) 0.95*scrsz(4)/2]);
% bar(z,p),
...
% affichage
% scrsz = get(0,'ScreenSize');
% fig1=figure(2); %'Position',[0.02*scrsz(3) 0.05*scrsz(4) 0.98*scrsz(3) 0.95*scrsz(4)/2]);
