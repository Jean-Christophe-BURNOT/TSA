...
%  biais attaché é la 'method'
%  - fth : un vecteur fréquence réduite de méme taille que Gth et Gbiais 
...
%
% Si method='simple' ou 'moyenne' le paramétre fenetre est ignoré
%
% Si method='welch', il faut spécifier le nom de la fenétre dans le 3éme
% paramétre
%
...
if or(strcmp(method,'simple'),strcmp(method,'moyenne'))
    ...
    % la fenétre de Bartlett en jeu va de -(Q-1) é Q-1
    LBart=2*Q-1;
    fenetre='bartlett';
    % recherche de la puissance de 2 supérieure é la taille de la fenétre
    ...
    % Gth convolué par la TF de la fenétre
    ...
    % calcul de la fenétre paire de Bartlett
...
if strcmp(method,'welch')
    ...
    %calcul de la fenétre
    eval(['wf=',fenetre,'(Lf);']);
    % calcul de la TF de la fenétre
    Hf=fft(wf,2*nfft);
